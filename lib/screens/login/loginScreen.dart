...
import 'package:college_hearts/screens/login/phoneSignupScreen.dart';
import 'package:college_hearts/screens/login/providers/google.dart';
        ...
        child: Column(
          ...
          children: [
            ...
            Padding(
              ...
              child: InkWell(
                onTap: () {
                  Navigator.push(context, CupertinoPageRoute(builder: (context)=> PhoneSignupScreen()));
                },
