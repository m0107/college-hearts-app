...
class _HelpAndSupportState extends State<HelpAndSupport> {
  ...
  final List<String> _faqAnswers = [
    ...
    'If you encounter a bug or issue, please report it to our customer support team by emailing us at support@collegeHearts.com.',
    'You can get in touch with our customer support team by emailing us at support@collegeHearts.com or by calling our toll-free number at 1-800-123-4567.',
  ];
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: 16.0),
            Text(
              'Email: support@collegeHearts.com',
              style: TextStyle(
                fontSize: 16.0,
              ),
            ),
